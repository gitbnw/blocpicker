...
var PortfoliosController = Paloma.controller('Portfolios');

PortfoliosController.prototype.create = function(){

  $(document).on('ready, page:change', console.log('portfolio paloma'));

};
(function() {
  var IsJsonString, checkRefresh, init_count, init_refresh, myStopFunction, refresh_portfolio, refresh_quotes;
  ...
  refresh_quotes = function(ids) {
    console.log(ids);
    return console.log(IsJsonString(JSON.stringify(ids)));
  };

  refresh_portfolio = function() {
    console.log('gon fired');
    return gon.watch('expired_stocks_ids', refresh_quotes);
  };
  ...
  init_count = function() {
    ...
    return gon.watch('count', init_refresh);
  };
